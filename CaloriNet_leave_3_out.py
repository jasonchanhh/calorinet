...
(xv_train, yv_train, lab_train) = CaloriesDataset.load_range_N((4,5,6,7,8,9,10,1,2), Set['buf_siz'], r'/calories_data')
(xa_train, ya_train, _) = CaloriesDataset.load_acc_range((4,5,6,7,8,9,10,1,2))
(xv_test, yv_test, lab_test) = CaloriesDataset.load_range_N((3,), Set['buf_siz'], r'/calories_data')
