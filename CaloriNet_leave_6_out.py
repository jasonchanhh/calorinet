...
network_name = 'CaloriNet_leave_6_out'
...
(xv_train, yv_train, lab_train) = CaloriesDataset.load_range_N((7,8,9,10,1,2,3,4,5), Set['buf_siz'], r'/mnt/storage/scratch/jc15502/calories_data')
(xa_train, ya_train, _) = CaloriesDataset.load_acc_range((7,8,9,10,1,2,3,4,5))
(xv_test, yv_test, lab_test) = CaloriesDataset.load_range_N((6,), Set['buf_siz'], r'/mnt/storage/scratch/jc15502/calories_data')
(xa_test, ya_test, _) = CaloriesDataset.load_acc_range((6,))
