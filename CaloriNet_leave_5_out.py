...
network_name = 'CaloriNet_leave_5_out'
...
(xv_train, yv_train, lab_train) = CaloriesDataset.load_range_N((6,7,8,9,10,1,2,3,4), Set['buf_siz'], r'/mnt/storage/scratch/jc15502/calories_data')
(xa_train, ya_train, _) = CaloriesDataset.load_acc_range((6,7,8,9,10,1,2,3,4))
(xv_test, yv_test, lab_test) = CaloriesDataset.load_range_N((5,), Set['buf_siz'], r'/mnt/storage/scratch/jc15502/calories_data')
(xa_test, ya_test, _) = CaloriesDataset.load_acc_range((5,))
